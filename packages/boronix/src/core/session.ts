...
export function createSession(req: Request, config: ResolvedBoronixConfig["session"]): InternalSession {
...
export function serializeSessionCookie(config: ResolvedBoronixConfig["session"], data: Record<string, unknown>): string {
...
export function readSessionData(req: Request, config: ResolvedBoronixConfig["session"]): Record<string, unknown> {
