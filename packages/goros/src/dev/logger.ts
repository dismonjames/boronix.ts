...
export function logRoutes(manifest: RouteManifest, runtime: ResolvedGorosConfig["runtime"], root: string): void {
  console.log("Goros dev server")
  console.log("")
...
export function logServer(host: string, port: number, runtime: ResolvedGorosConfig["runtime"]): void {
