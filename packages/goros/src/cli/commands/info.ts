...
export async function infoCommand(
  ...
  if (isPlain) {
    console.log(`* Goros info`)
  } else {
    console.log(`${colors.brand(symbols.header())} ${colors.bold("Goros info")}`)
  }
  console.log("")
...
function getGorosVersion(): string {
  try {
