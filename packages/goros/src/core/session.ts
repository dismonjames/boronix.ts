...
export function createSession(req: Request, config: ResolvedGorosConfig["session"]): InternalSession {
...
export function serializeSessionCookie(config: ResolvedGorosConfig["session"], data: Record<string, unknown>): string {
...
export function readSessionData(req: Request, config: ResolvedGorosConfig["session"]): Record<string, unknown> {
